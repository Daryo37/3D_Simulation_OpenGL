...
void Shader::CompileProgram()
{
	...
	//Avendo un numero variabile di PointLights questo for prende dallo shader il numero di points e si stampa il valore per popolare l array(vale per ogni elemento delle pointLight)
...
void Shader::SetDirectionalLight(Directional* dLight)
{
